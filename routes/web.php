...
Route::get('/import_data', [App\Http\Controllers\ReportController::class, 'import_data']);


Route::post('/get_locaion_segment', [App\Http\Controllers\ReportController::class, 'get_locaion_segment']);
Route::post('/import_master', [App\Http\Controllers\ReportController::class, 'import_master']);
